...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 `query` prompt listed via `list_prompts`
- [ ] #2 Filled prompt instructs index-first reading and citation discipline
- [ ] #3 `file_answer=true` branch instructs the LLM to call `page_write` + `index_upsert_entry` + `log_append`
- [ ] #4 Integration test against prompt template
<!-- AC:END -->
